...
- Name: stage3to5.spec.ts >> Stage 4: Draft >> Skip advances to next draft
- Location: tests/stage3to5.spec.ts:132:7
...
Call log:
  ...
  - waiting for locator('text=Tell me about a project')
    4 × waiting for" http://localhost:3001/" navigation to finish...
...
- dialog "Runtime Error":
  ...
  - link "Learn more about enabling Node.js inspector for server code with Chrome DevTools":
    ...
    - img
  - paragraph: "ENOENT: no such file or directory, open '/Users/eitan/Documents/Documents - Eitan's MacBook Air/git-repos/lumen/.next/server/pages/_document.js'"
  - paragraph: Call Stack 37
  - button "Show 37 ignore-listed frame(s)":
