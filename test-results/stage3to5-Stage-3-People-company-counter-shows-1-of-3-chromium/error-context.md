...
- Name: stage3to5.spec.ts >> Stage 3: People >> company counter shows 1 of 3
- Location: tests/stage3to5.spec.ts:73:7
...
Call log:
  ...
  - waiting for locator('text=Tell me about a project')
    2 × waiting for" http://localhost:3001/" navigation to finish...
